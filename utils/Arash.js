...
// the function show 2 number, total on the page and saved in localstorage
    ...
    updateRatio() {
        ...
        let newRatio = Number(ratio) +1
        localStorage.setItem("ratio", newRatio.toString())
    }

    updateClickPowerUi() {
        const clickPower = document.querySelector("#clickPower")
        let showClick = localStorage.getItem("ratio")
        clickPower.innerHTML = showClick
